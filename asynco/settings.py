"""
Django settings for asynco project.
...
SECRET_KEY = '-hmb$qraxt!!8^bmw97akc6+8fxta2k-&o^ty_y0fyxwtapps='
...
WSGI_APPLICATION = 'asynco.wsgi.application'
